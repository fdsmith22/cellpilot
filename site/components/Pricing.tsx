...
const Pricing = () => {
  ...
  return (
    <section id="pricing" className="min-h-screen flex items-center relative overflow-hidden pt-32 md:pt-28 sm:pt-24 max-sm:pt-24 pb-20 max-sm:pb-16 bg-transparent">
