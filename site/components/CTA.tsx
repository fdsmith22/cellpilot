...
const CTA = () => {
  ...
  return (
    <section className="snap-section relative overflow-hidden bg-transparent mb-0">
      ...
      <div className="container-wrapper relative z-10 flex items-center justify-center py-16 sm:py-20" style={{minHeight: 'calc(100vh - var(--header-height) - 400px)'}}>
