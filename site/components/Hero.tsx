...
const Hero = () => {
  ...
  return (
    <section className="snap-section relative min-h-screen overflow-hidden bg-transparent">
      {/* Animated blobs */}
      ...
      <div className="container-wrapper relative z-10 flex items-center justify-center min-h-screen pt-[104px] pb-8">
