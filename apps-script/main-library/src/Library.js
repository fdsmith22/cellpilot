...
var getCurrentSelection = getCurrentSelection || function() { return CellM8.getCurrentSelection(); };
var selectEntireDataRange = selectEntireDataRange || function() { return CellM8.selectEntireDataRange(); };
var selectRange = selectRange || function(rangeA1) { return CellM8.selectRange(rangeA1); };
var promptForSelection = promptForSelection || function() { return CellM8.promptForSelection(); };
...
var previewPresentation = previewPresentation || function(config) { return CellM8.previewPresentation(config); };
